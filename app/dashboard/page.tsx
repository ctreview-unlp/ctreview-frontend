      ...
      <main className="mx-auto w-full max-w-6xl px-5 py-7 sm:px-6 lg:px-10 lg:py-9">
        <div className="grid grid-cols-1 gap-5 lg:grid-cols-12 lg:items-start lg:gap-7">
          ...
          <section className="lg:col-span-8">
            <div className="relative overflow-hidden rounded-xl border border-[#E8E2D8] bg-white shadow-[0_1px_2px_rgba(20,18,16,0.04),0_8px_24px_rgba(20,18,16,0.04)] lg:min-h-[36rem]">
                ...
                {tab === 'session' && (
                  <div>
                    ...
                    <label
                      ...
                      onDrop={handleDrop}
                      className={`group relative mb-3 block cursor-pointer overflow-hidden rounded-xl border transition-[border-color,background-color,box-shadow] duration-150 ${
                        dragging
